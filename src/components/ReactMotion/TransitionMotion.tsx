...
function rehydrateStyles(
  mergedPropsStyles: TransitionStyle[],
  unreadPropStyles: TransitionStyle[],
  plainStyles: PlainStyle[],
...
function shouldStopAnimationAll(
  currentStyles: PlainStyle[],
  destStyles: TransitionStyle[],
...
function mergeAndSync(
  ...
  willLeave: WillLeave,
  didLeave: DidLeave,
  oldMergedPropsStyles: TransitionStyle[],
  destStyles: TransitionStyle[],
  oldCurrentStyles: PlainStyle[],
  oldCurrentVelocities: Velocity[],
  oldLastIdealStyles: PlainStyle[],
  oldLastIdealVelocities: Velocity[],
): [
  TransitionStyle[],
  PlainStyle[],
  Velocity[],
...
type TransitionMotionState = {
  ...
  currentStyles: PlainStyle[],
  currentVelocities: Velocity[],
  lastIdealStyles: PlainStyle[],
  lastIdealVelocities: Velocity[],
...
> {
  ...
  unreadPropStyles?: TransitionStyle[] | null = null;
  ...
  defaultState(): TransitionMotionState {
    ...
    const destStyles: TransitionStyle[] =
    ...
    let oldMergedPropsStyles: TransitionStyle[];
  ...
  // config)
  clearUnreadPropStyle = (unreadPropStyles: TransitionStyle[]): void => {
    let [
      mergedPropsStyles,
      currentStyles,
      currentVelocities,
  ...
  startAnimationIfNecessary = (): void => {
    ...
    this.animationID = defaultRaf(timestamp => {
      ...
      let destStyles: TransitionStyle[] =
