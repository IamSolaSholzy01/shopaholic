    ...
    <>
      ...
      >
        {currentStyles => (
          ...
          >
            <div
              className={`mt-16 pt-4 grid grid-cols-${list.length} items-center h-max text-sm font-semibold capitalize text-center`}
            >
              {list.map((item, index) => (
                <a
                  href={`#${item.route}`}
            ...
            <LoginTab visible={login_active} onClose={onClose} />
