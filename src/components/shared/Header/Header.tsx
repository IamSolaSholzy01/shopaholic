...
const Header = ({
  ...
  const list: [
    ...
    {
      text: "login",
      styleList: "text-white bg-yellow-500 hover:bg-yellow-600",
      route: "/login",
  ...
  const loginList: [
    ...
    {
      text: "logout",
      styleList: "text-white bg-yellow-500 hover:bg-yellow-600 rounded-full",
      route: "/logout",
      click: (event: SyntheticEvent) => {
        event.preventDefault();
    ...
    },
    {
      ...
      route: "/profile",
      styleList:
        "ml-8 inline-flex items-center justify-center px-1 py-2 border border-transparent rounded-full shadow-sm text-white",
      click: (event: SyntheticEvent) => {
        event.preventDefault();
