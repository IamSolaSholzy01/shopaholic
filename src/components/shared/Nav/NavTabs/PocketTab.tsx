...
const PocketTab = (visible: any) => {
    ...
    return (
        <>
            <div className={pocketVisible ? 'block' : 'hidden'}>
            <div>
                    <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">Use a Voucher</h2>
                    <p className="mt-2 text-center text-sm text-gray-600">
                        Don't have an account?&nbsp;
                        <Link component={RouterLink} to='/' className="font-medium text-rose-600 hover:text-rose-500">
                            Register
                        </Link>
                    </p>
                </div>
                <form className="mt-8 space-y-6 mx-6" action="#" method="POST">
                    ...
                    <div className="rounded-md shadow-sm -space-y-px">
                        <div>
                            ...
                            <input id="voucher" name="voucher" type="text" autoComplete="off" required={true} className="appearance-none rounded-md relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-primary focus:border-primary focus:z-10 sm:text-sm" placeholder="Voucher" />
                        </div>
                    </div>
